...
export const SHAPE_STYLES = {
  ...
  pencil:    { fill:'none',                 stroke:'rgba(255,255,255,.9)' },
  'dashed-arrow': { fill:'none',            stroke:'rgba(240,192,64,.9)' },
  text:      { fill:'none',                 stroke:'rgba(255,255,255,.9)' }
};
export const SHAPE_NAMES = { polygon:'Zona', zone:'Área', arrow:'Mov.', linked:'Ligação', ruler:'Medida', curve:'Curva', spotlight:'Foco', pencil:'Lápis', 'dashed-arrow':'Passe', text:'Texto' };
export const HINTS = {
  ...
  pencil:  'Lápis — prima e arraste para desenhar livremente',
  'dashed-arrow': 'Seta Tracejada (Passe) — clique pontos · duplo-clique para finalizar',
  text:    'Texto — clique no local pretendido para inserir texto flutuante'
};
export const BPZ = {
