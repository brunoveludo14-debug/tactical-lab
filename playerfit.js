/**
 * playerfit.js — Sistema de avaliação de jogadores por posição
 *
...
const ATTRS = [
  ...
  { key: 'tec', label: 'Técnica',    icon: '🎯' },
  { key: 'fis', label: 'Físico',     icon: '💪' },
    ...
    <div id="pfit-modal">
      <div class="pfit-head">
        <div>
          ...
          <div class="pfit-pos" id="pfit-player-pos">Posição</div>
        </div>
